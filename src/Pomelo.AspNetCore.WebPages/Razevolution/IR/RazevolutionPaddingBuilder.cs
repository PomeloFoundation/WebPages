...
{
    public class RazevolutionPaddingBuilder
    {
        ...
        public int CalculateStatementPadding(Span target)
        {
            ...
            var padding = CalculatePadding(target);
        ...
        public int CalculateExpressionPadding(Span target)
        {
            if (target == null)
            {
                throw new ArgumentNullException(nameof(target));
        ...
        internal int CalculatePadding(Span target)
        {
            ...
            padding = CollectSpacesAndTabs(target, _host.TabSize);
